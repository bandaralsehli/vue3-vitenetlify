<template>
        ...
        <div class="flex items-center justify-start"><span
          ...
          <h1 class="text-2xl leading-tight cursor-pointer" @click="Adminshow.setall()">الطلبات  الجديدة</h1>
          ...
          type="button" @click="Adminshow.setall()"><span class="inline-flex justify-center items-center w-6 h-6"><svg viewBox="0 0 24 24"
...
<script setup>
import { useAdminshowStore } from "@/stores";
const Adminshow = useAdminshowStore();
</script>