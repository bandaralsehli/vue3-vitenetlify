...
import theOverview from '@/components/admin/sections/Overview-dash.vue';
  ...
  <div
              ...
              <a
                ...
                <div class="flex items-center">
                 <span class="inline-flex justify-center items-center w-6 h-6 transition-colors"><svg
                    ...
                    </svg></span><span class="px-2 transition-colors">My Profile</span>
          ...
          <div
            ...
            <div class="flex items-center">
             <span class="inline-flex justify-center items-center w-6 h-6 transition-colors"><svg
                ...
                </svg></span><span class="px-2 transition-colors lg:hidden">GitHub</span>
    ...
    <aside id="aside"
      ...
      <div class="bg-gray-800 lg:rounded-2xl flex-1 flex flex-col overflow-hidden dark:bg-slate-900">
        <div class="bg-gray-900 text-white flex flex-row h-14 items-center justify-between dark:bg-slate-900">
          <div class="text-center flex-1 lg:text-left lg:pl-6 xl:text-center xl:pl-0"><b class="font-black">One</b>
          ...
          <ul>
            <li><a aria-current="page"
                class="router-link-active router-link-exact-active flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                  ...
                  </svg></span><span class="grow text-ellipsis line-clamp-1 pr-12 font-bold text-white">Dashboard</span>

              </a>

            </li>
            <li><a href="/dashboard/QR"
                class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                  ...
                  </svg></span><span class="grow text-ellipsis line-clamp-1 pr-12">Qr linkes</span>
            ...
            <li><a
                class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                  ...
                  </svg></span><span class="grow text-ellipsis line-clamp-1 pr-12">Tables</span>
            ...
            <li><a
                class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                  ...
                  </svg></span><span class="grow text-ellipsis line-clamp-1 pr-12">Forms</span>
            ...
            <li><a
                class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                  ...
                  </svg></span><span class="grow text-ellipsis line-clamp-1 pr-12">UI</span>
            ...
            <li><a
                class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                  ...
                  </svg></span><span class="grow text-ellipsis line-clamp-1 pr-12">Responsive</span>
            ...
            <li><a
                class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                  ...
                  </svg></span><span class="grow text-ellipsis line-clamp-1 pr-12">Styles</span>
            ...
            <li><a
                class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                  ...
                  </svg></span><span class="grow text-ellipsis line-clamp-1 pr-12">Profile</span>
            ...
            <li><a
                class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                  ...
                  </svg></span><span class="grow text-ellipsis line-clamp-1 pr-12">Login</span>
            ...
            <li><a
                class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                  ...
                  </svg></span><span class="grow text-ellipsis line-clamp-1 pr-12">Error</span>
            ...
            <li><a
                class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                  ...
                  class="inline-flex justify-center items-center w-12 h-6 flex-none"><svg viewBox="0 0 24 24" width="16"
                    height="16" class="inline-block">
                    <path fill="currentColor" d="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z"></path>
                  </svg></span></a>
              <ul class="bg-gray-700/50 hidden">
                <li><a
                    class="flex cursor-pointer py-3 px-6 text-sm text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white">
                   <span class="grow text-ellipsis line-clamp-1 pr-12">Item One</span>
                ...
                <li><a
                    class="flex cursor-pointer py-3 px-6 text-sm text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white">
                   <span class="grow text-ellipsis line-clamp-1 pr-12">Item Two</span>
            ...
            <li><a href="https://github.com/justboil/admin-one-vue-tailwind" target="_blank"
                class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                  ...
                  </svg></span><span class="grow text-ellipsis line-clamp-1 pr-12">GitHub</span>
            ...
            <li><a href="https://github.com/justboil/admin-one-react-tailwind" target="_blank"
                class="flex cursor-pointer py-3 text-gray-300 hover:text-white dark:text-slate-300 dark:hover:text-white"><span
                  ...
                  </svg></span><span class="grow text-ellipsis line-clamp-1 pr-12">React version</span>
    ...
    <section class="p-6 xl:max-w-6xl xl:mx-auto">
                  ...
                  <div class="justify-start items-center block md:flex">
                    ...
                    <div class="flex items-center justify-center">
                      <div class="text-center space-y-1 md:text-left md:mr-6">
                        ...
                        <p class="text-gray-500 dark:text-slate-400"><b>3 days ago</b> via Turcotte</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="justify-start items-center block md:flex">
                    ...
                    <div class="flex items-center justify-center">
                      <div class="text-center space-y-1 md:text-left md:mr-6">
                        ...
                        <p class="text-gray-500 dark:text-slate-400"><b>3 days ago</b> via Murazik - Graham</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="justify-start items-center block md:flex">
                    ...
                    <div class="flex items-center justify-center">
                      <div class="text-center space-y-1 md:text-left md:mr-6">
                        ...
                        <p class="text-gray-500 dark:text-slate-400"><b>5 days ago</b> via Fahey - Keebler</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="justify-start items-center block md:flex">
                    ...
                    <div class="flex items-center justify-center">
                      <div class="text-center space-y-1 md:text-left md:mr-6">
                        ...
                        <p class="text-gray-500 dark:text-slate-400"><b>7 days ago</b> via Collier - Hintz</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="flex-1 p-6">
              <div class="justify-between items-center block md:flex">
                <div class="flex items-center justify-center mb-6 md:mb-0">
                  <div class="justify-start items-center block md:flex">
                    <div class="flex items-center justify-center mb-6 md:mb-0">
                      <div class="w-12 h-12 mr-6"><img src="https://avatars.dicebear.com/api/avataaars/Howell-Hand.svg"
                          alt="Howell Hand"
            ...
            <div class="flex-1 p-6">
              <div class="justify-between items-center block md:flex">
                <div class="flex items-center justify-center mb-6 md:mb-0">
                  <div class="justify-start items-center block md:flex">
                    <div class="flex items-center justify-center mb-6 md:mb-0">
                      <div class="w-12 h-12 mr-6"><img src="https://avatars.dicebear.com/api/avataaars/Hope-Howe.svg"
                          alt="Hope Howe"
                          class="rounded-full block h-auto w-full max-w-full bg-gray-100 dark:bg-slate-800"></div>
                    </div>
                    <div class="flex items-center justify-center">
                      <div class="text-center md:text-left overflow-hidden">
                        ...
                        <p class="text-gray-500 dark:text-slate-400">Dec 1, 2021 @ dare.concepcion</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="flex-1 p-6">
              <div class="justify-between items-center block md:flex">
                <div class="flex items-center justify-center mb-6 md:mb-0">
                  <div class="justify-start items-center block md:flex">
                    <div class="flex items-center justify-center mb-6 md:mb-0">
                      <div class="w-12 h-12 mr-6"><img src="https://avatars.dicebear.com/api/avataaars/Nelson-Jerde.svg"
                          alt="Nelson Jerde"
                          class="rounded-full block h-auto w-full max-w-full bg-gray-100 dark:bg-slate-800"></div>
                    </div>
                    <div class="flex items-center justify-center">
                      <div class="text-center md:text-left overflow-hidden">
                        ...
                        <p class="text-gray-500 dark:text-slate-400">May 18, 2021 @ geovanni.kessler</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="flex-1 p-6">
              <div class="justify-between items-center block md:flex">
                <div class="flex items-center justify-center mb-6 md:mb-0">
                  <div class="justify-start items-center block md:flex">
                    <div class="flex items-center justify-center mb-6 md:mb-0">
                      <div class="w-12 h-12 mr-6"><img src="https://avatars.dicebear.com/api/avataaars/Kim-Weimann.svg"
                          alt="Kim Weimann"
                          class="rounded-full block h-auto w-full max-w-full bg-gray-100 dark:bg-slate-800"></div>
                    </div>
                    <div class="flex items-center justify-center">
                      <div class="text-center md:text-left overflow-hidden">
                        ...
                        <p class="text-gray-500 dark:text-slate-400">May 4, 2021 @ macejkovic.dashawn</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <!-- <div
        ...
        <div><a
            class="inline-flex justify-center items-center whitespace-nowrap focus:outline-none transition-colors focus:ring duration-150 border cursor-pointer rounded-full border-white ring-gray-200 dark:ring-gray-500 bg-white text-black hover:bg-gray-100 py-2 px-6"
      ...
      <!-- <div class="rounded-2xl flex-col dark:bg-slate-900/70 bg-white flex mb-6">
        <div class="flex-1 p-6">
          <div><canvas class="h-96" width="849" height="384"
              style="display: block; box-sizing: border-box; height: 384px; width: 849px;"></canvas></div>
        </div>
        ...
        <div class="justify-between items-center block md:flex">
          <div class="flex items-center justify-center mb-6 md:mb-0">
            <div class="flex flex-col md:flex-row items-center"><span
                class="inline-flex justify-center items-center w-10 md:w-5 h-10 md:h-5 md:mr-2"><svg viewBox="0 0 24 24"
                ...
                </svg></span><span class="text-center md:text-left md:py-2"><b>Responsive table.</b> Collapses on mobile
              </span></div>
          </div>
          ...
          <table>
            <thead>
              <tr>
                ...
                <!-- <th></th> -->
                <th class="w-80">أسم المقدم</th>
                <th class="w-80">الجهة</th>
                <th class="w-20">نوع الصيانة</th>
                <th class="w-40">الاهمية</th>
                <th class="w-40">تاريخ التقديم</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <!-- <td class="border-b-0 lg:w-6 before:hidden">
                  <div class="w-24 h-24 mx-auto lg:w-6 lg:h-6"><img
                      src="https://avatars.dicebear.com/api/avataaars/Howell-Hand.svg" alt="Howell Hand"
                      class="rounded-full block h-auto w-full max-w-full bg-gray-100 dark:bg-slate-800"></div>
                </td> -->
                <td data-label="Name">Howell Hand</td>
                <td data-label="Company">Kiehn-Green</td>
                <td data-label="City">Emelyside</td>
                <td data-label="Progress" class="lg:w-32"><progress class="flex w-2/5 self-center lg:w-full" max="100"
                    value="70">70</progress></td>
                <td data-label="Created" class="lg:w-1 whitespace-nowrap"><small
                    class="text-gray-500 dark:text-slate-400" title="Mar 3, 2021">Mar 3, 2021</small></td>
    ...
    <footer class="py-2 px-6 xl:max-w-6xl xl:mx-auto">
      <div class="justify-between items-center block md:flex">
        <div class="flex items-center justify-center mb-6 md:mb-0">
          <div class="text-center md:text-left"><b>©2022, <a href="https://justboil.me/"
                target="_blank">JustBoil.me</a>.</b> Get more with <a href="https://tailwind-vue.justboil.me/"
              target="_blank" class="text-blue-600">Premium version</a></div>
        </div>
        <div class="flex items-center justify-center">
